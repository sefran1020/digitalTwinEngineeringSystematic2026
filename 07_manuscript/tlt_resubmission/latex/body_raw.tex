...
competence \citep{feisel_role_2005, lei_teaching_2022, naukkarinen_supporting_2018}.
...
industrial state of the art \citep{lei_teaching_2022, prichetnikov_investigation_2020}.
...
formation tolerates the loss of physical access \citep{haase_teaching_2022, alkhedher_interactive_2021}. In response, virtual, remote and simulation-based
...
reaction engineering and control systems \citep{chumchuen_remote_2023, andrieu_remote_2021, panagiotakis_remote_2022, naukkarinen_supporting_2018, lei_teaching_2022}.
...
than on the medium alone \citep{ma_handson_2006, corter_constructing_2007, lindsay_effects_2005, brinson_learning_2015}. That literature is equally
...
methodological rigour \citep{brinson_learning_2015, heradio_virtual_2016, potkonjak_virtual_2016}. A recent review of digital technologies for practical
...
\citep{maladzhi_digital_2025}. The digital twin enters engineering education as the
...
context of product-lifecycle management \citep[as reported in][]{liljaniemi_using_2020}, a DT is a virtual representation of a physical asset
...
\citep{de_larmelina_conceptualizing_2026, weichbroth_toward_2024}. This definitional core is widely shared, but the term
remains contested. Analysing more than 15,000 publications, \citet{abdelrahman_what_2025} show that no consensus definition exists and that several features often
...
\citep[Kritzinger et al., 2018, as cited in][]{liljaniemi_using_2020, abdelrahman_what_2025, bokhtiar_al_zami_digital_2025}. This gradation matters pedagogically, because it
...
instrumented, synchronised cyber-physical system \citep{kabir_digital_2025, lee_digital_2025}. Establishing this maturity---rather than assuming it from the
...
\citep{saini_industry_2026, kabir_digital_2025}. Employers and accreditation bodies
...
collaboration and sustainability-oriented practice \citep{sell_international_2025, azofeifa_top_2025, dautaj_importance_2026}. Several studies document a
persistent mismatch between graduate competencies and labour-market expectations
\citep{denissova_factors_2026}, while survey evidence shows that engineering faculty
themselves often feel insufficiently prepared, and insufficiently equipped, to
teach these technologies \citep{cuperman_academic_2026}. DTs are proposed in this
...
factories \citep{zare_engineering_2026, nitu_engineering_2026, al-jumeily_implementing_2026}.
...
\citep{lampropoulos_virtual_2025, jin_extended_2026, fan_impacts_2025, espinoza_virtual_2025, llanos-ruiz_virtual_2025}. The evidence on these
...
alone, drives the effect \citep{giussani_study_2025, yindeemak_emerging_2026, lainidis_systematic_2026}. Within this landscape, DT-based education has
grown from early demonstrations in construction and mechanical engineering
\citep{sepasgozar_digital_2020, liljaniemi_using_2020, treffinger_investigations_2022}
...
\citep{khan_teaching_2026, kwateng_enhancing_2026, hunpinyo_isa95_2026, xiang_research_2025, bolanos_design_2026, lee_digital_2023}, often coupled with
project-based and experiential pedagogies and framed as preparation for
Industry 4.0/5.0 practice \citep{zhang_effectiveness_2024, ruppert_demonstration_2023, terkaj_virtual_2024, alvarez_ariza_investigating_2026}.
...
with DTs as one instance among many \citep{lampropoulos_virtual_2025, tokhayeva_virtualisation_2026, jiang_state_2026}, or to concentrate on a single
application niche, such as DT-coupled virtual learning environments for smart
manufacturing \citep{kumar_karanam_systematic_2025}. Across this body of work three
...
\citep{brinson_learning_2015, heradio_virtual_2016}, reviews rarely appraise the
...
on small, uncontrolled designs \citep{fan_impacts_2025, giussani_study_2025}.
...
\textbf{Table 1.} Prior reviews of digital twins and of technology-mediated laboratories in higher education, and whether each appraised the methodological quality of the underlying learning evidence. HE = higher education; SET = science, engineering and technology; DT = digital twin.
...
\bottomrule\noalign{}
\endlastfoot
\citep{lampropoulos_virtual_2025} & Scoping & VR in engineering education (342 studies) & No & No methodological-quality analysis of included studies \\
\citep{tokhayeva_virtualisation_2026} & Systematic & Virtualisation in HE; tools and cost & Partial & Weak primary designs; causal and economic inference limited \\
\citep{jiang_state_2026} & Bibliometric & VR in HE (1,100 papers) & No & Little empirical work on educational effects \\
\citep{kumar_karanam_systematic_2025} & Systematic & DT-coupled virtual environments for manufacturing education & No & No cost or scalability appraisal \\
\citep{chamorro-atalaya_use_2024} & Bibliometric & DT in university teaching and learning (92 papers) & No & No analysis of governance or teacher competence \\
\citep{omrany_digital_2026} & Systematic & DT for construction education and training (19 studies) & No & Fragmented, largely conceptual literature \\
\citep{vergara_decade_2025} & Bibliometric & DT in materials science and engineering (1,106 papers) & No & Output mapped; educational outcomes not appraised \\
\citep{maladzhi_digital_2025} & Systematic (PRISMA) & Digital technologies for practical SET teaching (28 studies) & Yes & Digital tools do not fully replace physical laboratories \\
\citep{ma_handson_2006} & Comparative review & Hands-on vs simulated vs remote laboratories & No & Establishes taxonomy and comparison; no quality weighting \\
\citep{brinson_learning_2015} & Review of empirical research & Learning outcomes: non-traditional vs hands-on labs & Partial & Prevailing ``no significant difference'', but weak designs dominate \\
\citep{heradio_virtual_2016} & Bibliometric & Virtual and remote labs & No & Trends mapped; primary-study quality not appraised \\
\citep{potkonjak_virtual_2016} & Review & Virtual laboratories for science, technology and engineering & No & Effectiveness reviewed without formal risk-of-bias assessment \\
\end{longtable}
}
...
\citep{maladzhi_digital_2025, li_effects_2026, widowati_meta-analysis_2025}) sit
\emph{outside} the digital-twin literature. Second, every review \emph{specific to digital
twins in education}---whether bibliometric \citep{chamorro-atalaya_use_2024, vergara_decade_2025} or systematic \citep{kumar_karanam_systematic_2025, omrany_digital_2026}---characterises or counts the literature without appraising the
...
\citep{ma_handson_2006, brinson_learning_2015, heradio_virtual_2016}.
...
\textbf{Constructive alignment} \citep{biggs_enhancing_1996, biggs_teaching_2011} supplies
...
the explicit, assessable purposes of laboratory work \citep{feisel_role_2005}.

\textbf{The ICAP framework} \citep{chi_icap_2014} refines how we read the pedagogy of
Objective O2. Decades of evidence establish that active engagement outperforms
passive reception in engineering and STEM instruction \citep{prince_does_2004, freeman_active_2014}, yet ``active learning'' is used so broadly that it obscures
...
\textbf{Kirkpatrick's levels of evaluation} \citep{kirkpatrick_kirkpatricks_2016} structure
...
outcomes of hands-on work, and on what quality of evidence \citep{ma_handson_2006, brinson_learning_2015}. Accordingly, the four objectives are read as alignment
...
specifically, the methodological guidance synthesised by \citet{borrego_systematic_2014}.
...
changes propagate physical→virtual \emph{and} virtual→physical. Standalone simulations
...
\includegraphics[width=5in,height=\textheight,keepaspectratio]{figs/F1_prisma.png}

\textbf{Figure 1.} PRISMA 2020 flow diagram of identification, screening and inclusion. Title/abstract screening combined an automated terminological screen with semantic screening by three independent large language model (LLM) agents and a fourth moderator agent (inter-agent Fleiss' κ = 0.60).
...
from anecdotal evidence \citep{streveler_conducting_2006}, we used a transparent,
...
Read through the ICAP lens \citep{chi_icap_2014}, the reported participation modes
...
adopted the language of active learning \citep{prince_does_2004, freeman_active_2014}
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F2_O2_pedagogia.png}

\textbf{Figure 3.} Pedagogical design and Industry 4.0/5.0 competencies (Objective O2): engineering domains, targeted competencies, pedagogical models and participation modes, with reporting rates. IIoT = industrial Internet of Things.
...
physical laboratory \citep{liljaniemi_enhancing_2025}---the very comparison the field's
foundational question requires \citep{ma_handson_2006, brinson_learning_2015}. Across
...
intervention, 60 control), \citet{kwateng_enhancing_2026} report a between-groups difference of t(198)=8.94, p\textless.001, a
...
rising from 68\% to 92\%; \citet{wang_innovative_2025} report Cohen's d=1.24 for knowledge
mastery, \citet{tarng_application_2024} an ANCOVA group effect of η²=0.50, and \citet{lu_digital_2025} Cohen's d=1.06 in algorithm-design and d=0.91 in debugging tasks. These cases show
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F3_O3_evidencia.png}

\textbf{Figure 4.} Empirical evidence of learning outcomes (Objective O3): research designs, comparators, reported outcome dimensions and the 0--6 evidence-quality composite. NASA-TLX = NASA Task Load Index.
...
that do quantify these dimensions are informative: \citet{bonavolonta_sustainability_2026}
...
completion rising to 70\% vs 56\%), and \citet{gallego_low-cost_2025} report a low-cost
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F4_O4_beneficios_barreras.png}

\textbf{Figure 5.} Institutional benefits and barriers (Objective O4): articulated benefits (accessibility, cost, sustainability, continuity) and reported barrier types (technical, institutional, pedagogical), with reporting rates. WEEE = waste electrical and electronic equipment.
...
\item
  ...
  \citet{sakkas_multiplayer_2025}; \citet{tarng_application_2024}; \citet{terkaj_framework_2024}), and
  only 1 combines a detailed architecture, AI and empirical evaluation
  (T2+T3+T6: \citet{machado_automatic_2025}).
\end{itemize}
...
\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F5_coocurrencia_temas.png}

\textbf{Figure 6.} Theme co-occurrence matrix: number of studies jointly activating each pair of the eight inductive themes (T1--T8).

\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F6_relacional.png}

\textbf{Figure 7.} Relational analyses: (a) rate of effect-size reporting by research design; (b) digital-twin maturity (Kritzinger taxonomy) by publication year.
...
1 study \citep{tarng_application_2024}. This near-empty frontier is the central structural gap of the field
...
effects --- including the controlled studies of \citet[between-group
gain +18.5 vs +4.3, t(198)=8.94]{kwateng_enhancing_2026}, \citet[ANCOVA F=71.9, p\textless0.001,
η²=0.50]{tarng_application_2024}, \citet[+31.2\% transfer to novel problems with retention at
3 and 6 months]{lin_visfactory_2025}, \citet[d=1.06 in algorithm design]{lu_digital_2025} and
\citet[+16.6\% vs +7.5\% knowledge mastery]{wang_innovative_2025}. These define the empirical frontier of
the field. Table 3 lists the four studies that assemble the most complete
technology--pedagogy--evidence stack \citep{sakkas_multiplayer_2025, tarng_application_2024, terkaj_framework_2024} or couple a detailed architecture with AI and evaluation
\citep{machado_automatic_2025}; notably, only \citet{tarng_application_2024} combines a high-maturity
twin with strong evidence, which is consistent with the decoupling and the empty
frontier identified above.

\textbf{Table 2.} Empirical studies reaching at least a moderate evidence-quality
...
\bottomrule\noalign{}
\endlastfoot
\citep{kwateng_enhancing_2026} & Manufacturing & Quasi-experiment & 200 & Control (no intervention) & Yes & Pre/post gain +18.5 vs +4.3 (control); t(198)=8.94, p\textless.001; d=0.91 (sensor-integration skills) & Strong (6) \\
\citep{lu_digital_2025} & Programming & Quasi-experiment & 135 & Traditional class & Yes & Algorithm design d=1.06; debugging d=0.91; overall post-test d=0.82 & Strong (6) \\
\citep{lin_visfactory_2025} & Automation & Experiment & 127 & Control group(s) & Yes & +31.2\% transfer to novel problems; higher retention at 3 and 6 months & Strong (5) \\
\citep{tarng_application_2024} & Robotics & Quasi-experiment & 75 & Traditional class & Yes & Post-test 8.71 vs 3.75; ANCOVA F=71.9, p\textless.001, η²=0.50 & Strong (5) \\
\citep{wang_innovative_2025} & Cybersecurity & Quasi-experiment & 60 & Traditional class & Yes & Knowledge mastery +16.6\% vs +7.5\% (control) & Strong (5) \\
\citep{khan_teaching_2026} & Manufacturing & Mixed-methods & 40 & Pre/post (within-subject) & No & 63\% improvement in course-evaluation scores & Moderate (4) \\
\citep{li_exploration_2025} & Chemical eng. & Case study / pilot & 95 & Traditional class & Yes & Knowledge-mastery gain 27.3\% vs 11.5\% (control) & Moderate (4) \\
\citep{liljaniemi_enhancing_2025} & Mechatronics & Quasi-experiment & 96 & Physical laboratory & No & VR group +11.85\% on component identification; parity on diagram interpretation & Moderate (4) \\
\citep{ning_exploration_2024} & Civil / construction & Quasi-experiment & 28 & Traditional class & No & Significantly better academic performance & Moderate (4) \\
\citep{ortiz_digital_2025} & Automation & Quasi-experiment & 16 & Pre/post (within-subject) & No & Task time 18.2→12.5 min; error rate 21.6\%→7.8\% & Moderate (4) \\
\citep{park_ar_2026} & NR & Quasi-experiment & 10 & Traditional class & No & Improved conceptual-knowledge quiz scores (pilot) & Moderate (4) \\
\citep{alvarez_ariza_investigating_2026} & Multi-case & Case study / pilot & 119 & Pre/post (within-subject) & Yes & 96.5--100\% agreement on fundamental-knowledge development & Moderate (4) \\
\citep{garcia_digital_2026} & Digital logic & Case study / pilot & 30 & None & Yes & Task completion 100\% / 93.3\% / 80\% / 73.3\% by difficulty & Moderate (3) \\
\citep{speicher_digital_2026} & Manufacturing & Case study / pilot & 6 & Traditional vs smart-mfg & No & Machining cycle time 58→28 min (\textgreater50\% reduction) & Moderate (3) \\
\citep{federal_university_of_amazonas_development_2025} & Postgraduate STEM & Mixed-methods & 24 & Pre/post (within-subject) & No & Share rating comprehension 4--5 rose to 90.9\% (from 27.3\%) & Moderate (3) \\
\end{longtable}
}

\textbf{Table 3.} Reference-architecture configurations: studies assembling the most
...
\bottomrule\noalign{}
\endlastfoot
\citep{sakkas_multiplayer_2025} & Full-stack (T1+T2+T5+T6) & Virtual-only & Digital shadow & --- & Active learning & Electronic circuits (Arduino, ESP32) & Weak \\
\citep{tarng_application_2024} & Full-stack (T1+T2+T5+T6) & Hybrid physical--virtual & Digital twin & --- & NR & WLKATA six-axis industrial robotic arm & Strong \\
\citep{terkaj_framework_2024} & Full-stack (T1+T2+T5+T6) & Hybrid physical--virtual & NR & --- & NR & Manufacturing plant & Weak \\
\citep{machado_automatic_2025} & Architecture + AI + evidence (T2+T3+T6) & Remote & NR & CNN, generative AI, LLM, data-driven & NR & Manufacturing plant (CP-LAB) & Weak \\
\end{longtable}
}

\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F7_red_atributos.png}

\textbf{Figure 8.} Attribute-association network. Nodes are binary study attributes; edges are pairwise φ associations whose bootstrap 95\% confidence interval (CI) excludes zero (B = 5,000). Communities: technical capability, evaluation rigour, curricular design.

\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F8_mapa_brechas.png}

\textbf{Figure 9.} Capability-by-evidence gap map: each empirical study plotted by technical-capability composite (0--1: maturity, synchronisation, AI, immersion) against evidence-quality score (0--6). The high-capability, strong-evidence corner is near-empty.

\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F9_espacio_3d.png}

\textbf{Figure 10.} Three-dimensional evidence space (technical capability × evidence quality × publication year). An interactive version is provided as supplementary material.

\includegraphics[width=6in,height=\textheight,keepaspectratio]{figs/F10_mca_embedding.png}

\textbf{Figure 11.} Multiple correspondence analysis (MCA) embedding of study attributes. The first axis (12.3\% of inertia) separates empirical from non-empirical/conceptual studies.
...
is almost empty. Read through constructive alignment \citep{biggs_enhancing_1996, biggs_teaching_2011}, this is a systemic misalignment: the field has invested
...
\citep{henderson_facilitating_2011}, and it reproduces for digital twins the very
...
\citep{brinson_learning_2015, heradio_virtual_2016}. This decoupling also mirrors a
tension documented across the wider DT
literature, where academic sophistication consistently outpaces validated
deployment and workforce readiness \citep{chen_ai-enhanced_2025}. It is compounded by
...
virtual-to-physical data-flow criteria would warrant \citep{thelen_comprehensive_2022}, and
that the field still lacks shared criteria for evaluating what a twin actually
does \citep{liu_cognitive_2025}. Claims of Industry 4.0/5.0 competence and institutional
...
industrial literature \citep{chen_ai-enhanced_2025, liu_cognitive_2025} thus remains marginal
...
of the underlying learning evidence \citep{chamorro-atalaya_use_2024};
...
literature \citep{omrany_digital_2026}; and materials-science mapping documents
exponential output without appraising educational outcomes at all
\citep{vergara_decade_2025}. By coupling a structured description of architecture and
...
virtual- and augmented-reality simulation \citep{li_effects_2026, almekkawi_effectiveness_2026}, and collaborative- or mobile-VR effects near Hedges'
g 0.47--0.50 \citep{chen_effects_2026, widowati_meta-analysis_2025}. This positioning warrants
...
\citep{widowati_meta-analysis_2025}---a trajectory consistent with novelty effects and weak
...
Kirkpatrick's evaluation hierarchy \citep{kirkpatrick_kirkpatricks_2016}. The corpus
...
specified multi-month follow-up (three and six months) \citep{lin_visfactory_2025}, and
...
two examined transfer at all \citep{zhong_virtual_2026}. Transfer cannot be assumed from immersion or visual
fidelity; it depends on functional rather than merely perceptual correspondence
\citep{harris_framework_2020}, and inadequate technical fidelity can even produce
negative transfer \citep{kim_effect_2026}. The corpus's habit of asserting twin
...
a single coherent system \citep{biggs_enhancing_1996}, and---where the goal is learner
self-direction in open-ended, capability-oriented tasks---student-agency models such
as heutagogy \citep{blaschke_heutagogy_2012}. One design in particular is conspicuously
...
\citep{chi_icap_2014}, and in constructionist terms it makes the learner the builder of
...
\citep{streveler_conducting_2006}. Concretely, this means
...
\citep{dayo_evaluating_2024}, with the reporting transparency that educational-technology
research is repeatedly found to lack \citep{demir_analyzing_2025}. For institutions,
...
\citep{eltaiba_benefits_2025}. For tool builders,
interoperability, synchronisation metrics and the validation of AI components
remain prerequisites for credible educational deployment \citep{chen_ai-enhanced_2025}.
...
\citep{widowati_meta-analysis_2025}. The agenda these gaps define is concrete: populate the
...
hands-on, virtual and remote laboratories have faced since \citet{ma_handson_2006} and
\citet{brinson_learning_2015}---whether a technology-mediated laboratory achieves the
...
assessment should be designed as a single aligned system \citep{biggs_teaching_2011},
the activities pitched at the constructive and interactive levels of cognitive
engagement that predict the largest gains \citep{chi_icap_2014}, and the targeted
competencies anchored to the recognised objectives of the instructional
laboratory \citep{feisel_role_2005} and to accreditation and curricular frameworks such
